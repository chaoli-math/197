...
\begin{proof}[Proposition \ref{pro:4.21} 的证明]
	...
	\[
		E'=\pi_1^{-1}(Y')\subset W
	\]
	是$W$的一个Cartier子概形。他当然是主的：其原像$E=\varphi^{-1}(Y)\subset \Bl_Y X$在$\Bl_Y X$中是局部主的，同时$E'\subset W$就是 \nottran
...
\paragraph*{作为$\proj$的爆破}\addcontentsline{toc}{subsubsection}{作为Proj的爆破}
