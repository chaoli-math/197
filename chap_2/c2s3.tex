...
\begin{center}\includegraphics[scale=\scale,bb=0 0 400 274]{chap_2/pics/6.png}\end{center}
...
\begin{wrapfigure}{r}{140pt}\vspace{-1em}\includegraphics[scale=0.5,bb=0 0 266 191]{chap_2/pics/7.png}\end{wrapfigure}
...
\begin{center}\includegraphics[scale=\scale,bb=0 0 399 296]{chap_2/pics/8.png}\end{center}
...
\begin{wrapfigure}[5]{r}{160pt}\vspace{-5em}\includegraphics[scale=0.5,bb=0 0 305 271]{chap_2/pics/9.png}\end{wrapfigure}
...
\begin{exe}
	设$K$是一个代数闭域，令$Z=\spec K[x_1,$ $\dots$, $x_n]/I\subset \mathbb{A}_K^n$是任意的度为3的支集为原点的零维子概形。证明，$Z$同构于$X=\spec K[x]/(x^3)$或者
	\[
...
\begin{center}\includegraphics[scale=\scale,bb=0 0 410 59]{chap_2/pics/11.png}\end{center}
...
一个理想$\mathfrak{q}\subset \pp$被称为$\pp$-\textit{准素}\index{准素!理想}的，如果$\pp$是$\mathfrak{q}$的\textit{根}\index{根}（那些存在一个幂在$\mathfrak{q}$中的元素构成的集合），任取$f$, $g\in R$满足$fg\in \mathfrak{q}$但$f\not\in \pp$，则我们有$g\in\mathfrak{q}$；等价地，$\mathfrak{q}$是$\pp$-准素的，如果$\pp$是它的根以及局部化映射$R/\mathfrak{q}\to R_{\pp}/\mathfrak{q}R_\pp$是一个单射。
...
\begin{center}\includegraphics[scale=\scale,bb=0 0 479 335]{chap_2/pics/12.png}\end{center}
...
\begin{center}\includegraphics[scale=\scale,bb=0 0 643 222]{chap_2/pics/13.png}\end{center}
\end{exe}
...
\begin{center}\includegraphics[scale=\scale,bb=0 0 684 279]{chap_2/pics/14.png}\end{center}
