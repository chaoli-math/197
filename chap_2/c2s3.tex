...
\begin{wrapfigure}{r}{140pt}\includegraphics[scale=0.5,bb=0 0 266 191]{chap_2/pics/7.png}\end{wrapfigure}
...
为了看看上面说的在实践中是什么意思，首先观察$I_t$生成元$x^2-a(t)x$, $xy-b(t)x$, $xy-a(t)y$以及$y^2-b(t)y$，它们当$t\to 0$的时候有清楚的极限$x^2$, $xy$, $xy$和$y^2$，于是这些多项式应该在$I$中。此外，观察$I_t$包含线性型\\\vspace{-3.2em}
\begin{wrapfigure}[15]{r}{160pt}\vspace{-1em}\includegraphics[scale=0.5,bb=0 0 305 271]{chap_2/pics/9.png}\end{wrapfigure}~
\[
